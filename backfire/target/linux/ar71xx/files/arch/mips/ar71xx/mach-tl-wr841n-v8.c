...
#define WR841N_V8_KEYS_DEBOUNCE_INTERVAL	(3 * WR841N_V8_KEYS_POLL_INTERVAL)
...
static struct gpio_keys_button wr841n_v8_gpio_keys[] __initdata = {
	{
		.desc		= "sw1",
		.type		= EV_KEY,
		.code		= BTN_0,
		.debounce_interval = WR841N_V8_KEYS_DEBOUNCE_INTERVAL,
...
MIPS_MACHINE(AR71XX_MACH_WR841N_V8, "TL_WR841N_V8", "TP-LINK WR841N_V8", wr841n_v8_setup);
