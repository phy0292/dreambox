...
define Profile/mini210-minimal
  NAME:=mini210 (minimal)
...
define Profile/mini210-minimal/Description
	minimal Package set compatible with the mini210 hardware
endef
$(eval $(call Profile,mini210-minimal))
